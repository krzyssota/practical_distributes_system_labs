...
public class ProductInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -175495042649688782L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductInfo\",\"namespace\":\"ks406362\",\"fields\":[{\"name\":\"product_id\",\"type\":\"string\"},{\"name\":\"brand_id\",\"type\":\"string\"},{\"name\":\"category_id\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"int\"}]}");
   ...
   */
  public static ks406362.ProductInfo.Builder newBuilder() {
    return new ks406362.ProductInfo.Builder();
  }
   ...
   * @return A new ProductInfo RecordBuilder
   */
  public static ks406362.ProductInfo.Builder newBuilder(ks406362.ProductInfo.Builder other) {
    if (other == null) {
      return new ks406362.ProductInfo.Builder();
    } else {
      return new ks406362.ProductInfo.Builder(other);
    }
  }
   ...
   * @return A new ProductInfo RecordBuilder
   */
  public static ks406362.ProductInfo.Builder newBuilder(ks406362.ProductInfo other) {
    if (other == null) {
      return new ks406362.ProductInfo.Builder();
    } else {
      return new ks406362.ProductInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductInfo>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ks406362.ProductInfo.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ks406362.ProductInfo other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.product_id)) {
        this.product_id = data().deepCopy(fields()[0].schema(), other.product_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public ks406362.ProductInfo.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ks406362.ProductInfo.Builder clearProductId() {
      product_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ks406362.ProductInfo.Builder setBrandId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ks406362.ProductInfo.Builder clearBrandId() {
      brand_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ks406362.ProductInfo.Builder setCategoryId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ks406362.ProductInfo.Builder clearCategoryId() {
      category_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ks406362.ProductInfo.Builder setPrice(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ks406362.ProductInfo.Builder clearPrice() {
